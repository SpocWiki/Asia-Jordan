...
twinned_administrative_body:
  - "[[db/Mostar|Mostar]]"
  - "[[db/Ramallah|Ramallah]]"
  - "[[db/Jeddah|Jeddah]]"
  - "[[db/Sylhet|Sylhet]]"
  - "[[db/Central_Governorate|Central_Governorate]]"
  - "[[db/Paphos_Municipality|Paphos_Municipality]]"
  - "[[db/Montreal|Montreal]]"
  ...
  - "[[db/Beijing|Beijing]]"
  - "[[db/Chicago|Chicago]]"
  - "[[db/Islamabad|Islamabad]]"
  - "[[db/Calabria|Calabria]]"
  - "[[db/Tokyo|Tokyo]]"
  - "[[db/Astana|Astana]]"
  - "[[db/Baghdad|Baghdad]]"
  - "[[db/Yerevan|Yerevan]]"
  - "[[db/Khartoum|Khartoum]]"
  - "[[db/Sanaa|Sanaa]]"
  - "[[db/Tegucigalpa|Tegucigalpa]]"
  - "[[db/Rabat|Rabat]]"
  - "[[db/Algiers|Algiers]]"
  - "[[db/Tunis|Tunis]]"
  - "[[db/Ankara|Ankara]]"
  - "[[db/Nouakchott|Nouakchott]]"
  - "[[db/Damascus|Damascus]]"
  - "[[db/Beirut|Beirut]]"
  - "[[db/Muscat|Muscat]]"
  - "[[db/Doha|Doha]]"
  - "[[db/Pretoria|Pretoria]]"
  - "[[db/Nalchik|Nalchik]]"
  - "[[db/Miami|Miami]]"
  - "[[db/Baku|Baku]]"
  - "[[db/Bishkek|Bishkek]]"
  - "[[db/Sarajevo|Sarajevo]]"
  - "[[db/Bucharest|Bucharest]]"
  - "[[db/San_Francisco|San_Francisco]]"
  - "[[db/Geneva|Geneva]]"
  - "[[db/Cairo|Cairo]]"
  - "[[db/São_Paulo|São_Paulo]]"
  - "[[db/Cincinnati|Cincinnati]]"
different_from: "[[db/Amman|Amman]]"
located_in_time_zone: "[[db/Eastern_European_Time|Eastern_European_Time]]"
capital_of:
  - "[[db/Amman_Governorate|Amman_Governorate]]"
  - "[[db/Emirate_of_Transjordan|Emirate_of_Transjordan]]"
  - "[[db/Jordan|Jordan]]"
located_in_the_administrative_territorial_entity: "[[db/Amman_Governorate|Amman_Governorate]]"
named_after: "[[db/Ammonites|Ammonites]]"
described_by_source:
  - "[[db/Encyclopædia_Britannica_11th_edition|Encyclopædia_Britannica_11th_edition]]"
  - "[[db/Pauly_Wissowa|Pauly_Wissowa]]"
  - "[[db/Encyclopedic_Lexicon|Encyclopedic_Lexicon]]"
  - "[[db/Larousse_Encyclopedia_online|Larousse_Encyclopedia_online]]"
  - "[[db/The_American_Cyclopædia|The_American_Cyclopædia]]"
  - "[[db/Meyers_Konversations_Lexikon,_4th_edition_(1885_1890)|Meyers_Konversations_Lexikon,_4th_edition_(1885_1890)]]"
  - "[[db/Armenian_Soviet_Encyclopedia,_vol._1|Armenian_Soviet_Encyclopedia,_vol._1]]"
replaces:
  - "[[db/Rabba|Rabba]]"
  - "[[db/Philadelphia|Philadelphia]]"
instance_of:
  - "[[db/big_city|big_city]]"
  - "[[db/city|city]]"
flag: "[[db/flag_of_Amman|flag_of_Amman]]"
history_of_topic: "[[db/history_of_Amman|history_of_Amman]]"
...
category_for_people_buried_here: "[[db/Q32397588|Q32397588]]"
topic_s_main_Wikimedia_portal: "[[db/Portal_Amman|Portal_Amman]]"
head_of_government: "[[db/Yousef_Shawarbeh|Yousef_Shawarbeh]]"
economy_of_topic: "[[db/economy_of_Amman|economy_of_Amman]]"
coordinate_location: Point(35.933333333 31.95)
country: "[[db/Jordan|Jordan]]"
official_language: "[[db/Arabic|Arabic]]"
area: 1680
